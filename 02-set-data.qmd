...
-   Note: to keep grading time reasonable, *please* <ins>keep your scripts in the top-level of your class folder</ins>, that way everyone is using the working directory and file paths
