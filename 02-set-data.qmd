...
1. Create a new R script (use the template provided if you'd like)
  - To keep things organized, I'd suggest naming it something like
    - `assignment-01.R` or `a-set-data.R`
...
3. Pick any single data file from IPEDS, download the STATA (.dta) version, save it to your `data` folder, and read it in to R, assigning it to an object (again, just like we did in class)
