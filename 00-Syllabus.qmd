...
-   git : [git-scm.com](https://git-scm.com)
    ...
    -   Students also need to sign up for a free GitHub account if they haven't already: [github.com/join](https://github.com/join)
...
+--------------+----------------------------------------+------------------------------------------------+
| Week         | Lesson(s)                              | Due (Sunday 11:59pm)                           |
+==============+========================================+================================================+
| 1            | -   Welcome                            | None                                           |
|              |                                        |                                                |
| Jan 9th      | -   Syllabus                           |                                                |
...
+--------------+----------------------------------------+------------------------------------------------+
| 2            | -   Excel Basics & Limitations         | -   Assignment 1                               |
|              |                                        |                                                |
| Jan 16th     | -   Reading Data Into R                |                                                |
|              |                                        |                                                |
|              | -   Intro to IPEDS                     |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 3            | -   Data Wrangling I                   | -   Assignment 2                               |
|              |                                        |                                                |
| Jan 23rd     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 4            | -   Data Wrangling II                  | -   Assignment 3                               |
|              |                                        |                                                |
| Jan 30th     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 5            | -   Data Visualization I               | -   Assignment 4                               |
|              |                                        |                                                |
| Feb 6th      |                                        | -   Reproducible Report: Proposal              |
+--------------+----------------------------------------+------------------------------------------------+
| 6            | -   Data Visualization II              | -   Assignment 5 (Graph replication challenge) |
|              |                                        |                                                |
| Feb 13th     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 7            | -   Introduction to Quarto             | -   Assignment 6                               |
|              |                                        |                                                |
| Feb 20th     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 8            | -   Data Wrangling III                 | -   Assignment 7                               |
|              |                                        |                                                |
| Feb 27th     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 9            | -   Data Wrangling IV                  | -   Reproducible Report: Initial Analysis      |
|              |                                        |                                                |
| Mar 5th      |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 10           | **Spring Break**                       | None, enjoy the break!                         |
|              |                                        |                                                |
| Mar 12th     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 11           | -   Functional Programming             | -   Assignment 8                               |
|              |                                        |                                                |
| Mar 19th     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 12           | -   Data Visualization III             | -   Assignment 9                               |
|              |                                        |                                                |
| Mar 26th     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 13           | **Matt In/Out**                        | -   Reproducible Report: Draft (Optional)      |
|              |                                        |                                                |
| Apr 2nd      | -   Reproducible Report: Lab Time      |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 14           | -   Data Visualization IV              | -   Assignment 10                              |
|              |                                        |                                                |
| Apr 9th      |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 15           | -   Reproducible Report: Presentations | -   Reproducible Report: Presentation          |
|              | -   Reproducible Report: Lab Time      |                                                |
| Apr 16th     |                                        |                                                |
+--------------+----------------------------------------+------------------------------------------------+
| 16           | -   Course Summary                     | -   Reproducible Report                        |
|              |                                        | -   Extra-Credit Assignments (Optional)        |
| Apr 23rd     | -   Reproducible Report: Lab Time      |                                                |
+--------------+----------------------------------------+------------------------------------------------+
...
Students with disabilities who experience learning barriers and would like to request academic accommodations should [connect with the disability Resource Center](https://disability.ufl.edu/students/get-started/). It is important for students to share their accommodation letter with their instructor and discuss their access needs, as early as possible in the semester.

### Course evaluations

Students are expected to provide professional and respectful feedback on the quality of instruction in this course by completing course evaluations online via GatorEvals. Guidance on how to give feedback in a professional and respectful manner is available [here](https://gatorevals.aa.ufl.edu/students/). Students will be notified when the evaluation period opens, and can complete evaluations through the email they receive from GatorEvals, in their Canvas course menu under GatorEvals, or [here](https://ufl.bluera.com/ufl/). Summaries of course evaluation results are available to students [here](https://gatorevals.aa.ufl.edu/public-results/).
