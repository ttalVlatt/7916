...
![RStudio gitcred prompt](site-attachments/btskinner-imgs/rstudio_gitcred1.png)
...
![GitHub PAT page](site-attachments/btskinner-imgs/github_pat.png)

You see a screen that looks like this:

![GitHub PAT page](site-attachments/btskinner-imgs/github_pat2.png)
...
![GitHub PAT page](site-attachments/btskinner-imgs/gitcreds_set.png)

It will as you to add your password. Paste the `gh_` PAT and press
enter. If it worked, you should see the following:

![GitHub PAT page: finish](site-attachments/btskinner-imgs/gitcreds_finish.png)
...
![GitHub student repo](site-attachments/btskinner-imgs/github_student_repo.png)

Just above the list of files, click on the button that says clone
(it's green by default).

![GitHub clone](site-attachments/btskinner-imgs/github_clone.png)
...
![RStudio new project](site-attachments/btskinner-imgs/rstudio_new_project.png)

This window will pop up.

![RStudio new project: version control](site-attachments/btskinner-imgs/rstudio_new_project_vc.png)
...
![RStudio new project: complete](site-attachments/btskinner-imgs/rstudio_new_project_complete.png) 
...
![RStudio new project: Git tab](site-attachments/btskinner-imgs/rstudio_git_tab.png)
...
![RStudio new project: Git history](site-attachments/btskinner-imgs/rstudio_git_history.png)
...
![RStudio new project: Git add](site-attachments/btskinner-imgs/rstudio_git_add.png)
...
![RStudio new project: Git commit](site-attachments/btskinner-imgs/rstudio_git_commit.png)
...
![RStudio new project: Git commit result](site-attachments/btskinner-imgs/rstudio_git_commit2.png)
...
![RStudio new project: Git post commit](site-attachments/btskinner-imgs/rstudio_git_post_commit.png)
...
![RStudio new project: Git push](site-attachments/btskinner-imgs/rstudio_git_push.png)
...
![RStudio new project: Git post push](site-attachments/btskinner-imgs/rstudio_git_post_push.png)
...
![RStudio new project: GitHub post push](site-attachments/btskinner-imgs/github_post_push.png)
...
![RStudio: pull](site-attachments/btskinner-imgs/rstudio_git_pull.png)

If there's nothing new, you'll get a message like this. If so, you're
good to go!

![RStudio: post pull](site-attachments/btskinner-imgs/rstudio_git_post_pull.png)
...
2. Set up the token authorization so you can push/pull GitHub from RStudio
3. Set up a R project for your reproducible-report folder
4. Set up and utilize the git functionality of that R project
