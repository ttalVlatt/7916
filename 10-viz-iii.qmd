...
- `state = "FL"` is telling the function to get data only for the
  ...
  example, if you added `county = "Alachua"`, you would only get
...
Equality](https://westwing.fandom.com/wiki/Organization_of_Cartographers_for_Social_Equality) and look at the
...
Using the `tigris` library and code from this lesson, make a different point map
