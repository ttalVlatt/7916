...
reader. We've already learned the basics of plotting in the [first data visualization lesson](05-viz-i.qmd), but we
...
that we first used in the [programming lesson](11-pro-functions.qmd).
