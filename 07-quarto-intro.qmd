...
[{{< fa question >}} Assignment Template (will be used through class)](/site-attachments/assignments/assignment-06.qmd)
...
-   Quarto is the replacement for RMarkdown
    ...
    -   Quarto is still somewhat new (it comes with RStudio as it's made by the same company, Posit)
...
> 2.  print out the data object we made called `data_long`
