...
- `kable()`is relatively basic in terms of customization, but, it can do most things you're going to need
    - FYI: The package `kableExtra` has a lot more advanced options for kable customization
...
- In this case, you can use some skills we will actually learn later in the class to help
 ...
 - At the end of the script you're trying to `source()` you can save the output as .`Rdata`
