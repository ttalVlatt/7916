...
-   In my day to day life I use them both
    -   If I'm writing extended passages of text, I usually use the visual editor (primarily for the Zotero referencing feature I mentioned above)
        -   If you know markdown syntax (e.g., headings, bold, etc.), you can type it into the visual editor rather than clicking on options
    -   If I'm writing code, I generally prefer the source editor
-   For this class, you should be able to use the visual editor for most of your needs, no need to learn markdown unless you want to!

> ## Quick Exercise
>
> 1.  Inside the Quarto template you downloaded at the top of the lesson write a few sentences describing your proposal for your reproducible report
...
-   When you render your Quarto document, the result is a `.docx` file that you can then open in word or send to a supervisor/adviser
    -   For example, if I'm running the data analysis for a project, I can create all the plots and tables, write up the methods section, then pass to my adviser to fill in the literature sections
