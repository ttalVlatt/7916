...
[Regular expressions](https://en.wikipedia.org/wiki/Regular_expression) (aka
...
1) How many chief administrator names start with "Dr."?  
   **NB** Many
   ...
   distinct names.
2) **BONUS** How many chief administrator names end with the title "PH.D." or
   some variant?
3) Among those schools that give their mission statement:
   i) How many repeat their institutional name in their mission
   statement?  
   ii) How many use the word _civic_?
   iii) Which top 3 states have the most schools with mission statements
