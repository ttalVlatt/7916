...
- `data_hs` := `hsls_small.dta`
- `data_ts` := `all_schools.csv`
...
- Since our `hsls_small` data is cross-sectional, we'll shift to using our school test score data `data_ts` from [Data Wrangling II](04-wrangle-ii.qmd)
