...
> Note from Matt: I've tried to leave this page relatively untouched from Dr. Skinner, therefore, you will notice a few differences from what we covered in class. This is exactly the point, everyone has their own personal preferences, but there are some common good ideas. Have a read through this page and start to form your own opinions and what makes sense for you!
...
From the [organizing lesson](02-set-data.qmd), we've been
...
In the [lesson on organizing](02-set-data.qmd), I
...
Throughout the course you've heard my (Matt's) approach to data wrangling, and now you've had a chance to read Dr. Skinner's (mostly similar, but a few differences). Considering all of that, please answer the following two questions in a Canvas text entry:
...
1. What organizational/work flow practice that I _have_ discussed do
   ...
   thoughts.
2. What organizational/work flow practice have I _not_ included that
   you think would help reduce error or improve reproducibility? Why?

Once complete, turn in the text box submission to Canvas by the due date (Sunday 11:59pm following the final lesson). Good faith efforts (as determined by the instructor) at extra credit assignments will earn full credit if submitted on time.
