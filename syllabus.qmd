...
-   **Instructor**: Jue Wu, Ph.D.
    -   **Email**: [juewu\@coe.ufl.edu](mailto:juewu@coe.ufl.edu)
    -   **Office Hours**: Thursday 10am - 12pm
    -   **Office Location**: Norman Hall 2705B
-   **TA**: Matt Capaldi
    -   **Email**: [m.capaldi\@ufl.edu](mailto:m.capaldi@ufl.edu)
    -   **Office Hours**: Monday 2pm - 4pm
    -   **Office Location**: Norman Hall 2705-P
-   **Class Meeting Time**: Wednesday 5:10pm - 8:10pm
-   **Class Location**: NRN 2025
...
+----------+----------+----------------------------------------+------------------------------------------------+
| 7        | Feb-26   | -   Introduction to Quarto             | -   Assignment 6                               |
+----------+----------+----------------------------------------+------------------------------------------------+
...
+----------+----------+----------------------------------------+------------------------------------------------+
| 15       | Apr-23   | -   Course Summary                     | -   Reproducible Report                        |
|          |          |                                        |                                                |
