...
1. Go to [this site](https://posit.co/download/rstudio-desktop/) and click the "Download RStudio Desktop for..." button underneath "2: Install RStudio" (we already did step 1)
...
1. Top left: Script window (will be closed at first if you don't have any
   scripts open)
2. Bottom left: Console
1. Top right: Environment / History / Connections
1. Bottom right: Files / Plots / Packages / Help / Viewer
...
- You may hear me use the phrases "base R" during class
  ...
  - While it's powerful in and of itself --- you can do everything you need with base R --- most of your scripts will make use of one of more contributed packages
    = These will make your data analytic life _much_ nicer. We'll lean heavily on the [tidyverse](https://www.tidyverse.org) suite of packages this semester.
...
If you really want something to do, start thinking about ideas for your [final project](99-Final-Project.qmd)!
